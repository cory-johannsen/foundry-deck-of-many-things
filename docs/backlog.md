...
_Last updated: 2026-09-20 (all open items migrated to GitHub Issues — see Active section below)_

## Active

Active work has moved to [GitHub Issues](https://github.com/cory-johannsen/foundry-deck-of-many-things/issues) so it's easier to track and share across sessions. This file no longer holds the live backlog for open items — the `## Done` section below stays as a historical record of finished work, but new items and state changes belong on the issue tracker, not here.

Migrated on 2026-09-20 (issue number — item — state at migration):
- [#93](https://github.com/cory-johannsen/foundry-deck-of-many-things/issues/93) — ITEM-18: Generate token art for the full core bestiary — `in-progress`
- [#94](https://github.com/cory-johannsen/foundry-deck-of-many-things/issues/94) — ITEM-23: Agent bridge for GM-less play — `spec`
- [#95](https://github.com/cory-johannsen/foundry-deck-of-many-things/issues/95) — ITEM-22: Sound effects for dungeon-crawl actions and outcomes — `backlog`
